...
# Filetype Dorks
# ==========================================
async def find_pdf(query: str, num: int = 100000) -> List[Any]:
    """Search for PDF documents."""
    return await GoogleSearchClient.search(f"{query} filetype:pdf", num_results=num)

async def find_doc(query: str, num: int = 100000) -> List[Any]:
...
async def find_xls(query: str, num: int = 100000) -> List[Any]:
...
async def find_ppt(query: str, num: int = 100000) -> List[Any]:
...
# ==========================================
async def find_config_files(query: str = "", num: int = 100000) -> List[Any]:
...
async def find_env_files(query: str = "", num: int = 100000) -> List[Any]:
    """Search for exposed .env files (High probability of false positives, but useful)."""
    q = f"{query} filetype:env"
    return await GoogleSearchClient.search(q, num_results=num)

async def find_database_dumps(query: str = "", num: int = 100000) -> List[Any]:
    """Search for SQL dumps."""
    q = f"{query} filetype:sql"
    return await GoogleSearchClient.search(q, num_results=num)

async def find_log_files(query: str = "", num: int = 100000) -> List[Any]:
    """Search for exposed log files."""
    q = f"{query} filetype:log"
    return await GoogleSearchClient.search(q, num_results=num)

async def find_backup_files(query: str = "", num: int = 100000) -> List[Any]:
...
# Site / URL Dorks
# ==========================================
async def site_search(query: str, domain: str, num: int = 100000) -> List[Any]:
    """Search within a specific domain."""
    return await GoogleSearchClient.search(f"site:{domain} {query}", num_results=num)

async def exclude_site(query: str, domain_to_exclude: str, num: int = 100000) -> List[Any]:
    """Search excluding a specific domain."""
    return await GoogleSearchClient.search(f"{query} -site:{domain_to_exclude}", num_results=num)

async def find_subdomains(domain: str, num: int = 100000) -> List[Any]:
...
async def find_login_pages(domain: str, num: int = 100000) -> List[Any]:
...
async def find_admin_pages(domain: str, num: int = 100000) -> List[Any]:
...
async def find_wordpress(domain: str, num: int = 100000) -> List[Any]:
    """Find WordPress components on a site."""
    return await GoogleSearchClient.search(f"site:{domain} inurl:wp-content", num_results=num)

async def find_directory_indices(domain: str = "", num: int = 100000) -> List[Any]:
...
# Platform Specific
# ==========================================
async def find_social_media(query: str, num: int = 100000) -> List[Any]:
