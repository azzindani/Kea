...
async def search_news(query: str, num: int = 100000) -> List[Any]:
...
async def search_finance_news(query: str, num: int = 100000) -> List[Any]:
...
async def search_tech_news(query: str, num: int = 100000) -> List[Any]:
...
async def get_headlines_topic(topic: str, num: int = 100000) -> List[Any]:
