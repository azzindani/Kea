...
async def get_stock_depth(arguments: dict, mode: str) -> ToolResult:
    """
    ...
    try:
        ...
        if mode == "description":
            ...
            return ToolResult(content=[TextContent(text=res)])
            ...
            return ToolResult(content=[TextContent(text=df.head(10).to_markdown())])
