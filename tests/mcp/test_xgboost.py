        ...
        async with ClientSession(read, write) as session:
            ...
            if not res.isError:
                # Returns model ID or path usually, or JSON
                 print(f" \033[92m[PASS]\033[0m Model Trained: {str(res.content[0].text)[:1000]}...")
            else:
            ...
            if not res.isError:
                 print(f" \033[92m[PASS]\033[0m Regressor: {res.content[0].text[:1000]}...")
            ...
            if not res.isError:
                 print(f" \033[92m[PASS]\033[0m Booster: {res.content[0].text[:1000]}...")
