...
from services.client.metrics import JobMetrics, MetricsCollector
...
from tests.stress.queries import QUERIES, StressQuery, get_query
...
class StressTestRunner:
    ...
    async def _execute_via_api(self, query: StressQuery) -> dict:
        ...
        print(f"\n{'='*70}")
        print("DEBUG: API REQUEST - query.prompt =")
