...
async def test_graph_synthesizer_comprehensive(subtasks_list, objective_text):
    ...
    print(f"   Simulation Verdict: {simulation_verdict.decision.value}")
    print(f" \033[92m[SUCCESS]\033[0m")
