...
class TestLogContext:
    ...
    def test_set_and_get_context(self):
        """Set and get context."""
        from shared.logging.context import LogContext, get_context, set_context
    ...
    def test_clear_context(self):
        ...
        from shared.logging.context import LogContext, get_context, reset_context, set_context
