...
class TestIntentDetector:
    ...
    def test_detect_follow_up(self):
        ...
        from services.orchestrator.core.conversation import Intent, IntentDetector
...
class TestSmartContextBuilder:
    ...
    def test_build_context(self):
        ...
        from services.orchestrator.core.conversation import ConversationSession, SmartContextBuilder
