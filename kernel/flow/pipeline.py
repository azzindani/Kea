...
class ConversationResearchPipeline:
    ...
    async def initialize(self):
        ...
        if is_feature_enabled("query_classifier"):
            try:
                from kernel.logic.query_classifier import get_classifier
        ...
        if is_feature_enabled("context_cache"):
            try:
                from kernel.memory.context_cache import get_context_cache
        ...
        # Research graph
        try:
            from kernel.flow.graph import compile_research_graph
    ...
    async def _handle_bypass(self, content: str, query_type: str) -> ResearchResult:
        ...
        if query_type == "casual":
            ...
            from kernel.logic.query_classifier import CasualHandler
            ...
            from kernel.logic.query_classifier import UtilityHandler
    ...
    async def _run_research(self, content: str, user_id: str) -> ResearchResult:
        ...
        try:
            from kernel.flow.graph import GraphState
